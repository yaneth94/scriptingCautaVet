...
products_name = productos['ProductName'].values
products_description = productos['Description'].values
products_code = productos['ProductCode'].values
